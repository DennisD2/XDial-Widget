...
SRCS = Dial.c Converters.c
SRCS1 = dial.c

OBJS = Dial.o Converters.o
OBJS1 = dial.o

INCDIR = .
DEBUG = -O
CFLAGS = $(DEBUG) -I$(INCDIR) -Wall

LDOPTIONS = -L. -static
LOCAL_LIBRARIES = -lDial
SYS_LIBS = -lXaw -lXt -lX11 -lm
LDLIBS = $(LOCAL_LIBRARIES) $(SYS_LIBS)
...
dial: dial.o libDial.a
	$(RM) $@
	$(CC) -o $@ dial.o $(LDOPTIONS)  $(LDLIBS)  $(EXTRA_LOAD_FLAGS)
...
tar:
	rm -f XDial.tar
	tar cvf XDial.tar $(SRCS) $(SRCS1) Imakefile *.h *.man *.ad
